...
public class CategoriaController {
	...
	@GetMapping("/generoJogo/{generoJogo}")
	public ResponseEntity<List<Categoria>> getById(@PathVariable String nomeJogo){
		return  ResponseEntity.ok(categoriaRepository.findAllByGeneroJogoContainingIgnoreCase(nomeJogo));
	}
